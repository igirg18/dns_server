...
#     DOMAIN=example.com
#    declare -A ANS=([A]="1.1.1.1" [MX]="aspmx.l.example.com" [NS]="ns1.example.com" [TXT]="v=spf1 mx ~all" [SOA]="2019100600")
#    run_test

#     # example2.com (Not Used in Test, uncomment to run)
#     DOMAIN=example2.com
#     declare -A ANS=([A]="38.21.5.14" [MX]="aspmx.l.example2.com" [NS]="ns1.example2.com" [TXT]="v=spf1 a mx ip4:69.64.153.131" [SOA]="2019100600")
#     run_test
#
#     # FreeUniCN19.com (Not Used in Test, uncomment to run)
#     DOMAIN=FreeUniCN19.com
#     declare -A ANS=([A]="4.8.15.16" [MX]="aspmx.l.FreeUniCN19.com" [NS]="ns1.FreeUniCN19.com" [TXT]="You Shall Not Pass!" [SOA]="2020506078")
#     run_test
}
...
#     stackoverflow.com
    ...
    declare -A ANS=([A]="91.239.206.136" [MX]="ASPMX.L.GOOGLE.COM." [NS]="ns1.proservice.ge." [TXT]="v=spf1 a mx ip4:91.239.206.136 ~all" [SOA]="root.freeuni.edu.ge." )
    run_test
}
